package com.example.erencanurun
...
class MainActivity : AppCompatActivity() {
    ...
    fun topla(v: View) {
        sayi1 = number1.text.toString().toIntOrNull()
        sayi2 = number2.text.toString().toIntOrNull()

        if (sayi1 == null) {
            sonucText.text = "Birinci Sayıyı Girin"
        } else if (sayi2 == null) {
            sonucText.text = "İkinci Sayıyı Girin"
        }
        else {
            sonuc = sayi1!! + sayi2!!
